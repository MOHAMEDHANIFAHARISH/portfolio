...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title"> Mohamed Hanifa Harish 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Hello! I'm a passionate and skilled web developer in designing and building user-friendly websites and web applications. My expertise lies in creating seamless and responsive user experiences, bringing creative visions to life through clean, efficient code.</p>
